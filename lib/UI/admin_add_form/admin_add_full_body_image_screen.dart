...
import 'admin_add_name_password_screen.dart';
...
class admin_add_full_body_image_screen extends StatefulWidget {
  ...
  _admin_add_full_body_image_screenState createState() =>
      _admin_add_full_body_image_screenState();
}

class _admin_add_full_body_image_screenState
    extends State<admin_add_full_body_image_screen> {
  @override
  File? _image;
    ...
    if (croppedFile != null) {
      ...
      uploadTask.whenComplete(() async {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => admin_add_name_password_screen(
                  widget.profile_url ?? '',
                  widget.id_card_url ?? '',
                  url ?? ''),
            ));
